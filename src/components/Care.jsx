          ...
          <div className="grid flex-box grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed my-1">
                Opatrunek należy nosić około 48 godzin. Przez okres w którym
                masz na sobie opatrunek nie musisz niczym smarować ani przemywać
                tatuażu. Opatrunek jest woodoodporny (można spokojnie brać z nim
                prysznic) i chroni przed czynnikami zewnętrznymi. *Pod
                opatrunkiem może zbierać się tusz i osocze - jest to normalne.
                *W przypadku wystąpienia uczulenia na klej od opatrunku (w
                miejscu plastra skóra robi się czerwona i swędzi ) - należy
                zdjąć opatrunek szybciej.
              </p>
              <ul className=" px-2 list-disc leading-relaxed mb-2 text-gray-700">
                ...
                <li>
                  Smarujemy tatuaż cienką warstwą kremu ( można używać
                  bepanthen, polecam również kremy przeznaczone typowo do
                  pielęgnacji tatuażu - np. Easy tattoo, balm tattoo, krem neba)
                </li>
                <li>
              ...
              <p className="text-gray-700 mb-1">
                <b>
                  Po upływie 4-10 dni tatuaż może się łuszczyć , jest to
                  naturalny proces gojenia. Nie należy drapać/zrywać strupków,
                  może to doprowadzić do powstania ubytków w tatuażu.
                </b>
              </p>
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-6">
                  ...
                  Czego unikać ? - Przez pierwsze 2-3 dni nie spożywaj alkoholu.
                  - Przez pierwszy tydzień unikaj wysiłku fizycznego. - Przez
                  pierwsze 2 tygodnie unikamy długich kąpieli i gorących kąpieli
